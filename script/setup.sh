...
cp ~/nixos/assets/easyeffects/bass.json ~/.config/easyeffects/output/bass.json

# Add the tommorow-night theme for btop
mkdir -p ~/.config/btop/themes/
cp ~/nixos/assets/btop/themes/tommorow-night.theme ~/.config/btop/themes/tommorow-night.theme
